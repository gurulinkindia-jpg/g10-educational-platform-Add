...
$('prepareGithub').onclick=()=>{try{
 ...
 preparedCard={id,image,title:state.text.headline,html:new Blob([publishedCardHtml(id,state.text.headline,canvas.width,canvas.height)],{type:'text/html;charset=utf-8'})};showPrepared();
